...
to [connect@themindful.life](mailto:connect@themindful.life).
...
This section guides you through submitting an enhancement suggestion for CONTRIBUTING.md, **including completely new features/content and minor improvements to existing content or functionality**. Following these guidelines will help maintainers and the community to understand your suggestion and find related suggestions.
...
## Styleguides
This project uses Google style guides [here](https://google.github.io/styleguide/) according to the language of the code.
